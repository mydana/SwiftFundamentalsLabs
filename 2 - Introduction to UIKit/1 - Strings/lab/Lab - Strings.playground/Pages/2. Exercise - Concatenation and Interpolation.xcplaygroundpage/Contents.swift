 ...
 */
print("--- Exercise - Concatenation and Interpolation ---")
let city = "La Cañada Flintridge"
...
let name = "Dana Runge"
let age: Int = 55
print("My name is \(name) and after my next birthday I will be \(age + 1) years old. Older than dirt!")
