...
print("---- Page 3 ----")
var testValue = 10
print("testValue initial value: \(testValue)")
testValue += 5
print("testValue with addition of 5: \(testValue)")
testValue *= 2
print("testValue with multiplication by 2: \(testValue)")
 ...
 */
var piggyBank = 0
print("piggyBank initial value: \(piggyBank)")
piggyBank += 10
print("piggyBank after neighbor gives you money: \(piggyBank)")
piggyBank += 20
print("piggyBank after earning more money: \(piggyBank)")
piggyBank /= 2
print("piggyBank after dinner and movie: \(piggyBank)")
piggyBank *= 3
print("piggyBank after washing windows: \(piggyBank)")
piggyBank -= 3
print("piggyBank after buying stuff at the convenience store: \(piggyBank)")
