...
//print("The value of foo is \(foo)")
//It's out of scope, as scope is inside the {}
...
// x is in the outer scope by virtue of being defined outside of it.
 ...
 */
func greeting(greeting: String?=nil, name: String) {
...
print(Car(make:"Subaru", model:"Outback", year:2008))
