...
let newBest = 15125
let congratulations = "Congratulations, \(fullName)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday! For a difference of \(newBest - previousBest) steps!"
