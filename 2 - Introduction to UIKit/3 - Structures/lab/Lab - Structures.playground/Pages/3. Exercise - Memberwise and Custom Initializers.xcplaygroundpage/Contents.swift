 ...
 */
print("--- Exercise - Memberwise and Custom Initializers ---")
struct GPS {
    var latitude: Double
 ...
 */
struct Height {
    // Yes, I know the exercise says "variable properties"
    // I'm experimenting
...
print(Height(heightInInches: 65))
print(Height(heightInCentimeters: 165.1))
 ...
 */
var myHeight = Height(heightInInches: 6 * 12 + 3)
print(myHeight)
